 ...
 */
final class Version20200114185742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE depot (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, montant BIGINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, compte_id INT DEFAULT NULL, numero_compte VARCHAR(255) NOT NULL, solde VARCHAR(255) NOT NULL, INDEX IDX_CFF65260F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
